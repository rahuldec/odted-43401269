// Patched to point at user's own Supabase project. Reads URL/anon from VITE_ env
// (Vite injects these into server bundles too) so Cloud-managed SUPABASE_* env
// vars (which still point at the old Cloud project) are bypassed.
